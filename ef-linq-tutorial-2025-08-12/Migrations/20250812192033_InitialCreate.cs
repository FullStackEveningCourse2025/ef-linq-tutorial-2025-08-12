        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name_First = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Name_Last = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_Name_Last_Name_First",
                table: "Students",
                columns: new[] { "Name_Last", "Name_First" });
        }
